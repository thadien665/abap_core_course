CLASS zcl_01_learning_v02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_01_LEARNING_V02 IMPLEMENTATION.
...
CONSTANTS c_number TYPE i VALUE 12345. "Uncomment this line to see syntax error ( VALUE is mandatory)
...
out->write( 12345 ). "Number Literal (Type I) "uncomment this line to see syntax error (no number literal with digits)
*out->write( 12345.67 ).
  ENDMETHOD.
ENDCLASS.
