CLASS zcl_01_learning_v18 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_01_learning_v18 IMPLEMENTATION.
...
CLEAR connection.
connection = VALUE #( airport_from_id = 'ABC' airport_to_id = 'XYZ' carrier_name = 'My Airline' ).
" Nested VALUE to fill nested structure
connection_nested = VALUE #( airport_from_id = 'ABC' airport_to_id = 'XYZ' message = VALUE #( msgty = 'E' msgid = 'ABC' msgno = '123' ) carrier_name = 'My Airline' ).
...
out->write( data = connection name = `Source Structure:`).
