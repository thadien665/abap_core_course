...
DATA standard_table TYPE STANDARD TABLE OF zs4d401_flights4 WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
DATA sorted_table TYPE SORTED TABLE OF zs4d401_flights4 WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
DATA hashed_table TYPE HASHED TABLE OF zs4d401_flights4 WITH UNIQUE KEY carrier_id connection_id flight_date.
...
METHOD constructor.
SELECT FROM zs4d401_flights4 FIELDS * INTO TABLE @standard_table.
SELECT FROM zs4d401_flights4 FIELDS * INTO TABLE @sorted_table.
SELECT FROM zs4d401_flights4 FIELDS * INTO TABLE @hashed_table.
